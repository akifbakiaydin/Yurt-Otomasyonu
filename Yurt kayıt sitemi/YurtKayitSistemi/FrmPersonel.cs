...
namespace YurtKayitSistemi
{
    public partial class FrmPersonel : Form
    {
        ...
        private void FrmPersonel_Load(object sender, EventArgs e)
        {
            ...
            this.personelTableAdapter1.Fill(this.yurtOtomasyonDataSet10.Personel);
            // TODO: This line of code loads data into the 'yurtOtomasyonDataSet9.Personel' table. You can move, or remove it, as needed.
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komutgun.Parameters.AddWithValue("@p3", TxtPersonelİd.Text);
